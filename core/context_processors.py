...
def company_info(request):
    ...
    return {
        ...
        "COMPANY_EMAIL": "info@dreamstourstravels.in",
        "COMPANY_ADDRESS_LINE1": "Nearby Temple Road",
        "COMPANY_ADDRESS_LINE2": "Rameswaram, Tamil Nadu - 623518",
        "COMPANY_CITY": "Rameswaram",
        "SITE_URL": getattr(settings, "SITE_URL", "https://www.dreamstourstravels.in"),
        "GOOGLE_MAP_EMBED": (
